...
export class InfoService implements OnModuleInit {
  ...
  async onModuleInit() {
    ...
    // Xóa data cũ để dễ test nghiệm thu
    await this.zoneRepo.clear();
    await this.showRepo.clear();
    ...
    const concerts = [
      { showId: '1', name: 'NEON DREAMS FESTIVAL 2024', performanceDate: new Date('2026-10-24T18:00:00Z'), location: 'My Dinh Stadium, Hanoi', status: 'ON_SALE' },
      { showId: '2', name: 'Midnight Jazz Session', performanceDate: new Date('2026-11-15T20:00:00Z'), location: 'Binh Minh Jazz Club', status: 'ON_SALE' },
      { showId: '3', name: '[Dốc Mộng Mơ] Starlight - Quốc Thiên', performanceDate: new Date('2026-06-06T19:30:00Z'), location: 'Trung Tâm Nghệ Thuật Âu Cơ, Hà Nội', status: 'ON_SALE' },
      { showId: '4', name: 'Anh Trai "Say Hi" 2025', performanceDate: new Date('2025-12-05T19:30:00Z'), location: 'Phu Tho Stadium, HCMC', status: 'ON_SALE' },
    ];
    await this.showRepo.insert(concerts);

    const zones = [
      // Show 1
      { showId: '1', zone: 'SVIP', price: 2000000, totalCapacity: 50, availableSlots: 50 },
      { showId: '1', zone: 'VIP', price: 1000000, totalCapacity: 150, availableSlots: 150 },
      { showId: '1', zone: 'GA', price: 500000, totalCapacity: 500, availableSlots: 500 },
      // Show 2
      { showId: '2', zone: 'VIP', price: 1500000, totalCapacity: 30, availableSlots: 30 },
      { showId: '2', zone: 'Standard', price: 800000, totalCapacity: 100, availableSlots: 100 },
      // Show 3
      { showId: '3', zone: 'SVIP', price: 2500000, totalCapacity: 100, availableSlots: 100 },
      { showId: '3', zone: 'VIP', price: 1500000, totalCapacity: 200, availableSlots: 200 },
      { showId: '3', zone: 'Normal', price: 800000, totalCapacity: 400, availableSlots: 400 },
      // Show 4
      { showId: '4', zone: 'SVIP', price: 3000000, totalCapacity: 50, availableSlots: 50 },
      { showId: '4', zone: 'VIP1', price: 2000000, totalCapacity: 150, availableSlots: 150 },
      { showId: '4', zone: 'VIP2', price: 1500000, totalCapacity: 200, availableSlots: 200 },
      { showId: '4', zone: 'GA', price: 700000, totalCapacity: 600, availableSlots: 600 },
    ];
    await this.zoneRepo.insert(zones);

    const infos = [
      { 
        showId: '1', description: 'The world\'s largest immersive digital music experience returns to Hanoi for one night only.', artistBio: 'Top DJs from Tomorrowland', mediaUrls: [], rules: 'No outside food or drinks. 18+ only.', coverImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuD8MdEbV0frFQ0aUda3LPIZoCnoqzhBMvmWD98rbMKXvOwDQe3pTMC4nDpABZ5roTCvYwoe5uftLPC7_TaIOIFEQLScUn1fn4B8T03oJWqir5Y4EAUfts1eS2fnWeVqxtYm2z_RHWTK5A7Vm53sOkycXQhf4iQRRsT9dgj8hz6Ev7eWe7x-_EMCcQo_7DVDwxazTtds9IV9jDkg7KynE5CQEClt3PbcDutBIDcUkqo6c_52J37uBrqp2c4RqDVSoGlcPE8NjCUSKBY2',
        zoneSetups: [
      ...
      { 
        showId: '3', description: 'Đêm nhạc thay lời cảm ơn chân thành tới đại gia đình nhà Mây.', artistBio: 'Ca sĩ Quốc Thiên và ban nhạc', mediaUrls: [], rules: 'Tickets are non-refundable.', coverImage: '/starlight-2026.jpg',
        zoneSetups: [
      ...
      { 
        showId: '4', description: 'Đêm nhạc hội tụ 30 Anh Trai với những màn trình diễn đỉnh cao chưa từng có.', artistBio: '30 Anh Trai hot nhất Vbiz', mediaUrls: [], rules: 'Không mang đồ ăn thức uống', coverImage: '/anh-trai-say-hi-2025.png',
        zoneSetups: [
    ...
    const promise = (async () => {
      try {
        ...
        const finalData = postgresShows.map(show => {
          const info = mongoInfos.find(i => i.showId === show.showId);
          return {
            id: show.showId,
            name: show.name,
